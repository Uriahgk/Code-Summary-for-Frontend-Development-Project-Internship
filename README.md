# Live Project
## Introduction
On my two week Live Project with the Tech Academy I worked with a team on the front end of a LifeStyle Website Project where we created webpages that represented different hobbies and (of course) lifestyles. We were tasked to build these webpages with the following technologies: HTML, CSS, Bootstrap, JavaScript, Axios, Git and AzureDevOps. 
